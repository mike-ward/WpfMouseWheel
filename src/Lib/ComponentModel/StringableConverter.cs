...
namespace Logitech.ComponentModel
{
    public abstract class StringableConverter<T> : TypeConverter
    {
        ...
        /// <summary>
        ///     Determines whether an object of the specified type can be converted to an instance of T,using the specified
        ///     context.
        /// </summary>
        /// <returns>true if this converter can perform the operation; otherwise, false.</returns>
        /// <param name="context">
        ///     A format context that provides information about the environment from which this converter is
        ///     being invoked.
        /// </param>
        ...
        ///     <paramref name="source" /> does not map to a valid T.
        /// </exception>
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object source)
        {
            if (source is string)
            {
                ...
                {
                    throw new FormatException(string.Format("{0} is not a valid value for {1}", source, typeof(T)),
                        exception);
                }
            }
        ...
        ///     <paramref name="value" /> does not map to a valid T.
        /// </exception>
        /// <exception cref="T:System.NotSupportedException">

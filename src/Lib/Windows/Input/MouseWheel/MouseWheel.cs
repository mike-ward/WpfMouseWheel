...
namespace Logitech.Windows.Input
{
    ...
    public partial class MouseWheel : NativeMotionSource
    {
        ...
        public MouseWheel(MouseDevice mouseDevice = null, int id = 0)
        {
            ...
            _sNewWheel?.Invoke(this, EventArgs.Empty);
        }
        ...
        public INativeMotionTransferOutput this[double resolution] => _activeTransferCase[resolution];
        ...
        public IMouseWheelTransferCase ActiveTransferCase
        {
            ...
            private set
            {
                ...
                ActiveTransferCaseChanged?.Invoke(this, EventArgs.Empty);
            }
        }
        ...
        private static readonly DependencyPropertyKey ResolutionPropertyKey =
            DependencyProperty.RegisterReadOnly("Resolution", typeof(double), typeof(MouseWheel),
        ...
        public IMotionInfo MotionInfo => _activeTransferCase.MotionInfo;

        public double Remainder => _activeTransferCase.Remainder;
        ...
        public int NativeRemainder => _activeTransferCase.NativeRemainder;
        ...
        public override int NativeResolutionFrequency => _nativeResolutionFrequency;
        ...
        public MouseWheelResolution ResolutionMode => NativeResolutionFrequency < NativeNotchFrequency
            ? MouseWheelResolution.High
            : MouseWheelResolution.Standard;

        public int NativeNotchFrequency
        {
            [DebuggerStepThrough] get { return NativeNotchFrequencyDefault; }
        }
        ...
        private void SetNativeResolutionFrequency(int value)
        {
            ...
            OnResolutionFrequencyChanged();
        }

        private string GetName()
        {
            return MouseDevice == Mouse.PrimaryDevice ? "Primary Mouse Wheel" : $"Mouse Wheel [{Id}]";
        }
        ...
        private void UpdateActiveTransferCase()
        {
            if (NativeResolutionFrequency >= 20)
                ...
                ActiveTransferCase = new MouseWheelMultiShaftTransferCase(this);
            Next = _activeTransferCase;
        }

        private void OnResolutionFrequencyChanged()
        {
    ...
    public partial class MouseWheel
    {
        ...
        public static MouseWheel Current { get; private set; }
        ...
        private static EventHandler _sNewWheel;
    ...
    public partial class MouseWheel
    {
        ...
        public static readonly DependencyProperty EnhancedProperty = DependencyProperty.RegisterAttached("Enhanced",
            typeof(bool), typeof(MouseWheel),
            new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.Inherits,
                MouseWheelController.BeginEnsurePatchController));
        ...
        public static readonly DependencyProperty ScrollModeProperty = DependencyProperty.RegisterAttached(
            "ScrollMode", typeof(MouseWheelScrollMode), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty VScrollModeProperty =
            DependencyProperty.RegisterAttached("VScrollMode", typeof(MouseWheelScrollMode), typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollMode.Auto, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty HScrollModeProperty =
            DependencyProperty.RegisterAttached("HScrollMode", typeof(MouseWheelScrollMode), typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollMode.Auto, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty VScrollModifiersProperty =
            DependencyProperty.RegisterAttached("VScrollModifiers", typeof(ModifierKeys), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty HScrollModifiersProperty =
            DependencyProperty.RegisterAttached("HScrollModifiers", typeof(ModifierKeys), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty ScrollSmoothingProperty =
            DependencyProperty.RegisterAttached("ScrollSmoothing", typeof(MouseWheelSmoothing), typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelSmoothing.Smooth, FrameworkPropertyMetadataOptions.Inherits,
                    OnScrollSmoothingChanged));
        ...
        public static readonly DependencyProperty VScrollSmoothingProperty =
            DependencyProperty.RegisterAttached("VScrollSmoothing", typeof(MouseWheelSmoothing), typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelSmoothing.Smooth, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty HScrollSmoothingProperty =
            DependencyProperty.RegisterAttached("HScrollSmoothing", typeof(MouseWheelSmoothing), typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelSmoothing.Smooth, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty LogicalScrollDebouncingProperty =
            DependencyProperty.RegisterAttached("LogicalScrollDebouncing", typeof(MouseWheelDebouncing),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelDebouncing.None, FrameworkPropertyMetadataOptions.Inherits,
                    OnLogicalScrollDebouncingChanged));
        ...
        private static void OnLogicalScrollDebouncingChanged(DependencyObject sender,
        ...
        public static readonly DependencyProperty LogicalVScrollDebouncingProperty =
            DependencyProperty.RegisterAttached("LogicalVScrollDebouncing", typeof(MouseWheelDebouncing),
                typeof(MouseWheel),
        ...
        public static readonly DependencyProperty LogicalHScrollDebouncingProperty =
            DependencyProperty.RegisterAttached("LogicalHScrollDebouncing", typeof(MouseWheelDebouncing),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelDebouncing.Auto, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty PhysicalScrollDebouncingProperty =
            DependencyProperty.RegisterAttached("PhysicalScrollDebouncing", typeof(MouseWheelDebouncing),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelDebouncing.None, FrameworkPropertyMetadataOptions.Inherits,
                    OnPhysicalScrollDebouncingChanged));
        ...
        private static void OnPhysicalScrollDebouncingChanged(DependencyObject sender,
            DependencyPropertyChangedEventArgs e)
        {
        ...
        public static readonly DependencyProperty PhysicalVScrollDebouncingProperty =
            DependencyProperty.RegisterAttached("PhysicalVScrollDebouncing", typeof(MouseWheelDebouncing),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelDebouncing.None, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty PhysicalHScrollDebouncingProperty =
            DependencyProperty.RegisterAttached("PhysicalHScrollDebouncing", typeof(MouseWheelDebouncing),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelDebouncing.None, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty LogicalScrollIncrementProperty =
            DependencyProperty.RegisterAttached("LogicalScrollIncrement", typeof(MouseWheelScrollIncrement),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollIncrement.StarLogicalDefault,
                    FrameworkPropertyMetadataOptions.Inherits, OnLogicalScrollIncrementChanged));
        ...
        private static void OnLogicalScrollIncrementChanged(DependencyObject sender,
            DependencyPropertyChangedEventArgs e)
        {
            var mouseWheelScrollIncrement = e.NewValue as MouseWheelScrollIncrement;
            if (mouseWheelScrollIncrement != null) SetLogicalVScrollIncrement(sender, mouseWheelScrollIncrement.Clone(Orientation.Vertical));
            var wheelScrollIncrement = e.NewValue as MouseWheelScrollIncrement;
            if (wheelScrollIncrement != null) SetLogicalHScrollIncrement(sender, wheelScrollIncrement.Clone(Orientation.Horizontal));
        }
        ...
        public static readonly DependencyProperty LogicalVScrollIncrementProperty =
            DependencyProperty.RegisterAttached("LogicalVScrollIncrement", typeof(MouseWheelScrollIncrement),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollIncrement.StarLogicalDefaultV,
        ...
        public static readonly DependencyProperty LogicalHScrollIncrementProperty =
            DependencyProperty.RegisterAttached("LogicalHScrollIncrement", typeof(MouseWheelScrollIncrement),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollIncrement.StarLogicalDefaultH,
                    FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty PhysicalScrollIncrementProperty =
            DependencyProperty.RegisterAttached("PhysicalScrollIncrement", typeof(MouseWheelScrollIncrement),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollIncrement.StarPhysicalDefault,
                    FrameworkPropertyMetadataOptions.Inherits, OnPhysicalScrollIncrementChanged));
        ...
        private static void OnPhysicalScrollIncrementChanged(DependencyObject sender,
            DependencyPropertyChangedEventArgs e)
        {
            var mouseWheelScrollIncrement = e.NewValue as MouseWheelScrollIncrement;
            if (mouseWheelScrollIncrement != null) SetPhysicalVScrollIncrement(sender, mouseWheelScrollIncrement.Clone(Orientation.Vertical));
            var wheelScrollIncrement = e.NewValue as MouseWheelScrollIncrement;
            if (wheelScrollIncrement != null) SetPhysicalHScrollIncrement(sender, wheelScrollIncrement.Clone(Orientation.Horizontal));
        }
        ...
        public static readonly DependencyProperty PhysicalVScrollIncrementProperty =
            DependencyProperty.RegisterAttached("PhysicalVScrollIncrement", typeof(MouseWheelScrollIncrement),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollIncrement.StarPhysicalDefaultV,
                    FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty PhysicalHScrollIncrementProperty =
            DependencyProperty.RegisterAttached("PhysicalHScrollIncrement", typeof(MouseWheelScrollIncrement),
                typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelScrollIncrement.StarPhysicalDefaultH,
                    FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty NestedScrollProperty =
            DependencyProperty.RegisterAttached("NestedScroll", typeof(bool), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty NestedVScrollProperty =
            DependencyProperty.RegisterAttached("NestedVScroll", typeof(bool), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty NestedHScrollProperty =
            DependencyProperty.RegisterAttached("NestedHScroll", typeof(bool), typeof(MouseWheel),
                new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty ZoomModifiersProperty =
            DependencyProperty.RegisterAttached("ZoomModifiers", typeof(ModifierKeys), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty ZoomSmoothingProperty =
            DependencyProperty.RegisterAttached("ZoomSmoothing", typeof(MouseWheelSmoothing), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty ZoomDebouncingProperty =
            DependencyProperty.RegisterAttached("ZoomDebouncing", typeof(MouseWheelDebouncing), typeof(MouseWheel),
                new FrameworkPropertyMetadata(MouseWheelDebouncing.Auto, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty NestedZoomProperty = DependencyProperty.RegisterAttached(
            "NestedZoom", typeof(bool), typeof(MouseWheel),
            new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.Inherits));
        ...
        public static readonly DependencyProperty ModifiersProperty = DependencyProperty.RegisterAttached("Modifiers",
            typeof(ModifierKeys), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty SmoothingProperty = DependencyProperty.RegisterAttached("Smoothing",
            typeof(MouseWheelSmoothing), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty DebouncingProperty = DependencyProperty.RegisterAttached(
            "Debouncing", typeof(MouseWheelDebouncing), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty NestedMotionProperty =
            DependencyProperty.RegisterAttached("NestedMotion", typeof(bool), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty IncrementProperty = DependencyProperty.RegisterAttached("Increment",
            typeof(double), typeof(MouseWheel),
        ...
        public static readonly DependencyProperty MinimumProperty = DependencyProperty.RegisterAttached("Minimum",
            typeof(double), typeof(MouseWheel),
            new FrameworkPropertyMetadata(0.0, MouseWheelController.BeginEnsureMapController));
        ...
        public static readonly DependencyProperty MaximumProperty = DependencyProperty.RegisterAttached("Maximum",
            typeof(double), typeof(MouseWheel),
            new FrameworkPropertyMetadata(0.0, MouseWheelController.BeginEnsureMapController));
